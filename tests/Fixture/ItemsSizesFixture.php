 ...
 *
 */
class ItemsSizesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'stocks' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'size_id' => 1,
                'stocks' => 1,
                'created' => '2018-09-04 15:42:39',
                'modified' => '2018-09-04 15:42:39'
            ],
        ];
        parent::init();
    }
