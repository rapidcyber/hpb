...
class PhotosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'img_file' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-09-04 15:49:27',
                'modified' => '2018-09-04 15:49:27'
            ],
        ];
        parent::init();
    }
