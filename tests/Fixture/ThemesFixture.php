...
class ThemesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'filename' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-09-04 15:49:48',
                'modified' => '2018-09-04 15:49:48',
                'type_id' => 1
            ],
        ];
        parent::init();
