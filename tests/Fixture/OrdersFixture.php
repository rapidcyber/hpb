...
class OrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'quantity' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'modified' => '2018-09-04 15:48:45',
                'created' => '2018-09-04 15:48:45'
            ],
        ];
        parent::init();
    }
